...
#=======Change These===============================
tf.app.flags.DEFINE_string("model_name", "BiDAF_bilinear_end_position_lstm_filter_adadelta", "name of the model")
tf.app.flags.DEFINE_string("train_dir", "train/BiDAF_bilinear_end_position_lstm_filter_adadelta", "Training directory, INCLUDE model name!!")
tf.app.flags.DEFINE_string('summaries_dir', 'summary/BiDAF_bilinear_end_position_lstm_filter_adadelta', 'tensorboard summary dir')
tf.app.flags.DEFINE_integer("state_size", 100, "Size of each model layer.")
tf.app.flags.DEFINE_bool('filter_flag', True, 'if true, use filter layer')
tf.app.flags.DEFINE_integer("embedding_size", 100, "Size of the pretrained vocabulary.")
tf.app.flags.DEFINE_integer("decay_number", 50, "Decay by 0.99 every decay_number")
tf.app.flags.DEFINE_float("learning_rate", 0.1, "Base Learning rate.")
#==================================================

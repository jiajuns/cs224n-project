...
#=======Change These===============================
tf.app.flags.DEFINE_string("model_name", "BiDAF_bilinear_end_position_lstm_filter", "name of the model")
tf.app.flags.DEFINE_string("train_dir", "train/BiDAF_bilinear_end_position_lstm_filter", "Training directory, INCLUDE model name!!")
tf.app.flags.DEFINE_string('summaries_dir', 'summary/BiDAF_bilinear_end_position_lstm_filter', 'tensorboard summary dir')

...
tf.app.flags.DEFINE_string("model_name", "test", "name of the model")
tf.app.flags.DEFINE_string("train_dir", "train/test", "Training directory, INCLUDE model name!!")
...
tf.app.flags.DEFINE_integer("train_size", 5000, "Size of the training data")

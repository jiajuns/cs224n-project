...
#=======Change These===============================
tf.app.flags.DEFINE_string("model_name", "BiDAF_bilinear_embedding_300_prevent_overfit_1", "name of the model")
tf.app.flags.DEFINE_string("train_dir", "train/BiDAF_bilinear_embedding_300_prevent_overfit_1", "Training directory, INCLUDE model name!!")
tf.app.flags.DEFINE_string('summaries_dir', 'summary/BiDAF_bilinear_embedding_300_prevent_overfit_1', 'tensorboard summary dir')
...
tf.app.flags.DEFINE_float("dropout", 0.30, "Fraction of units randomly dropped on non-recurrent connections.")
